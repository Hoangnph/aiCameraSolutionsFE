...
Kiểm tra tất cả services của Face Detection System
"""
...
class ServiceChecker:
    ...
    def run_comprehensive_check(self):
        ...
        print("🚀 Starting Comprehensive Service Check")
        print("=" * 60)
        ...
        # Save results
        results_file = f"service_check_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"
